...
- `username` _{string}_ - The username of the friend to be added
...
- `username` _{string}_ - The username of the user rating
- `upvote` _{boolean}_ - True if upvoting, false if downvoting
